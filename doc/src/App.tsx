    ...
    <div className="flex flex-col max-w-screen-lg mx-auto w-full gap-24 p-8">
      <header className="flex w-full items-center justify-between gap-4">
        <div className="border rounded-3xl border-black/10">
          <div className="pl-6 pr-4 py-4 flex items-center gap-2 border border-gray-200/10 rounded-3xl bg-card">
            ...
            <a
              ...
              className="opacity-40 hover:opacity-100 transition duration-300 ml-20"
            >
              <img
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="bg-primary text-primary-foreground hover:bg-primary/80 transition px-4 py-2 rounded-xl flex items-center gap-2 ml-1"
            >
              <img
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="flex items-center mb-4">
            <input
              ...
              className="py-4 px-6 text-lg rounded-2xl border border-foreground/10 bg-input bg-background text-foreground flex-grow font-mono"
